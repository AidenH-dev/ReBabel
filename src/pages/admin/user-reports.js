...
import {
  ...
  useBugReports,
  useBugReportTable,
} from '@/components/Tables/admin/usr-bug-report';
...
function AdminUserReportsPage() {
  ...
  const { paginatedReports, sortedReports, totalPages } =
    tableHook.getPaginatedReports(
  ...
  return (
    <AuthenticatedLayout
      sidebar="admin"
      title="User Reports - ReBabel Admin"
      ...
      <div className="max-w-7xl mx-auto p-6 md:p-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            <FaExclamationTriangle className="text-xl text-brand-pink" />
            <h1 className="text-3xl font-bold">User Reports</h1>
          </div>
          <p className="text-gray-600 dark:text-gray-400">
            Manage user bug reports and feedback
          </p>
        </div>
        ...
        {activeTab === 'feedback' && (
          <div>
            <div className="bg-white dark:bg-surface-card rounded-lg p-8 border border-gray-200 dark:border-gray-800 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                User feedback collection and analysis features are being
                developed.
              </p>
            </div>
          </div>
