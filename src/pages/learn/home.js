...
export default function Home() {
  ...
  const handleEditMaterials = (learning_materialId) => {
    // Navigate to upload page or open modal
    router.push(
      `/learn/learning_material/edit-learning_material/${learning_materialId}`
    );
  };
              ...
              >
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        onClick={() =>
                          handleEditMaterials(learning_material.id)
                        }
                      >
                        <FaEdit />
                      </button>
                ...
                <div className="p-6 space-y-3">
                  ...
                  {learning_material.sections.map((section) => (
                    <div
                      ...
                      onClick={() =>
                        router.push(`/learn/section/${section.id}`)
                      }
                    >
                ...
                {learning_material.upcomingDeadlines.length > 0 && (
                  <div className="px-6 pb-6">
                    ...
                    <div className="space-y-2">
                      {learning_material.upcomingDeadlines.map(
                        (deadline, idx) => (
                          <div
                            key={idx}
            ...
            >
              <div className="flex flex-col items-center justify-center h-full min-h-[300px] text-gray-400 group-hover:text-brand-pink transition-colors">
                ...
                <p className="text-sm mt-1">
                  Upload your textbook or class materials
                </p>
              </div>
            </div>
          </div>
