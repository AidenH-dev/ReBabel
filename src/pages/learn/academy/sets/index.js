...
export default function VocabularyDashboard() {
  ...
  return (
    <div className="flex flex-row h-screen overflow-hidden bg-white dark:bg-[#141f25] text-[#222] dark:text-white">
      ...
      {/* Main */}
      <main className="ml-auto flex-1 flex flex-col h-screen overflow-y-auto bg-gray-50 dark:bg-[#141f25] px-6 sm:px-10 sm:mt-0 py-8 pt-[max(2rem,var(--cap-safe-top))]">
        <BeginnerPackPopup
        ...
        <div className="hidden sm:block w-full max-w-6xl mx-auto mb-4 bg-gray-50 dark:bg-[#0f1a1f] rounded-lg p-2 border border-black/10 dark:border-white/10">
          <div className="flex items-stretch justify-between gap-3">
            {/* Stats Cards - Left */}
            <div className="flex items-stretch gap-3">
              <div className="flex items-center gap-3 bg-white dark:bg-[#1c2b35] rounded-xl px-3 py-2 shadow-sm border border-black/5 dark:border-white/5">
                <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-blue-50 dark:bg-blue-500/10">
                  <TbStack2 className="w-5 h-5 text-blue-500" />
                </div>
                <div>
                  ...
                  <p className="text-xl font-bold text-black dark:text-white">
                    {isLoadingStats ? '—' : dashboardStats.totalSets}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white dark:bg-[#1c2b35] rounded-xl px-3 py-2 shadow-sm border border-black/5 dark:border-white/5">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-black dark:text-white">
                    {isLoadingStats ? '—' : dashboardStats.totalItems}
                  </p>
                </div>
              </div>
              <div className="flex w-fit items-center gap-3 bg-white dark:bg-[#1c2b35] rounded-xl px-3 py-2 shadow-sm border border-black/5 dark:border-white/5">
                <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-violet-50 dark:bg-violet-500/10">
                  <TbRepeat className="w-4 h-4 text-violet-500" />
                </div>
                <div>
                  <p className="text-xs font-medium text-black/50 dark:text-white/50 uppercase tracking-wide whitespace-nowrap">
                    SRS Active
                  </p>
                  <p className="text-xl font-bold text-black dark:text-white flex gap-1.5 items-baseline whitespace-nowrap">
                    {isLoadingStats ? '—' : dashboardStats.activeSrsItems}
              ...
              <div className="flex w-fit items-center gap-3 bg-white dark:bg-[#1c2b35] rounded-xl px-3 py-2 shadow-sm border border-black/5 dark:border-white/5">
                <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-amber-50 dark:bg-amber-500/10">
                  <TiChartPieOutline className="w-5 h-5 text-amber-500" />
                </div>
                <div>
                  <p className="text-xs font-medium text-black/50 dark:text-white/50 uppercase tracking-wide whitespace-nowrap">
                    Set Distribution
                  ...
                  <div className="flex gap-2 items-baseline">
                    {isLoadingSets ? (
                      ...
                      <>
                        <span className="text-sm font-bold px-1 rounded-lg bg-blue-100 dark:bg-blue-900/60">
                          {
                            recentsSets.filter((s) => s.set_type === 'vocab')
                              .length
                          }
                          {' V'}
                        </span>
                        ...
                        <span className="text-sm font-bold px-1 rounded-lg bg-green-100 dark:bg-green-900/60">
                          {
                            recentsSets.filter((s) => s.set_type === 'grammar')
                              .length
                          }
                          {' G'}
                        </span>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  ...
                  <div className="flex items-center gap-1 rounded-lg bg-black/[0.04] dark:bg-white/[0.06] p-1">
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-md text-md font-medium transition ${
                        srsView === 'dashboard'
                          ? 'bg-white dark:bg-[#0f1a1f] text-[#e30a5f] shadow-sm'
                          : 'text-black/70 dark:text-white/70 hover:text-black dark:hover:text-white'
                      }`}
                      ...
                      <div className="bg-white dark:bg-[#1d2a32] border border-black/5 dark:border-white/10 rounded-lg p-4">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between items-center py-1">
                            ...
                            <span className="text-sm font-semibold text-[#e30a5f]">
                  ...
                  <div className="flex flex-col gap-4">
                      ...
                      <div className="flex items-center w-min gap-1 rounded-lg bg-black/[0.04] dark:bg-white/[0.06] p-1">
                        <button
                          ...
                          className={`px-2 py-1 rounded-md text-xs flex items-center gap-1 transition ${
                            srsSetView === 'grid'
                              ? 'bg-white dark:bg-[#0f1a1f] text-[#e30a5f]'
                    ...
                    {(() => {
                      const filteredSrsSets = srsSets.filter((set) =>
                        set.name
                          .toLowerCase()
                          .includes(srsSearchQuery.toLowerCase())
                      );
                      ...
                      if (filteredSrsSets.length === 0 && srsSearchQuery) {
                        return (
                          <div className="rounded-lg border border-dashed border-black/10 dark:border-white/10 p-6 text-center text-sm text-black/70 dark:text-white/70">
                            <p>
                              No SRS sets found matching &quot;{srsSearchQuery}
                              &quot;
                            </p>
                          </div>
                        );
                        ...
                        return (
                          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                            {filteredSrsSets.map((set) => (
                              <div
                                key={set.id}
                                className="bg-white dark:bg-[#1d2a32] border border-black/5 dark:border-white/10 rounded-lg p-4 hover:shadow-sm transition-shadow"
                              >
                                {/* Set Header */}
                                ...
                                <div className="mb-3">
                                  <div className="flex justify-between text-[10px] text-gray-600 dark:text-gray-400 mb-1">
                                    ...
                                    <span>
                                      {Math.round(
                                        (set.reviewCards / set.totalCards) * 100
                                      )}
                                      %
                                    </span>
                                  </div>
                                  <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5">
                                    <div className="flex h-1.5 rounded-full overflow-hidden">
                                      <div
                                        ...
                                        style={{
                                          width: `${(set.reviewCards / set.totalCards) * 100}%`,
                                        }}
                                      />
                                      <div
                                        className="bg-orange-500"
                                        style={{
                                          width: `${(set.learningCards / set.totalCards) * 100}%`,
                                        }}
                                      />
                                      <div
                                        className="bg-blue-500"
                                        style={{
                                          width: `${(set.newCards / set.totalCards) * 100}%`,
                                        }}
                                      />
                                    </div>
                                  </div>
                        ...
                        return (
                          <div className="divide-y divide-black/5 dark:divide-white/10 rounded-lg overflow-hidden border border-black/5 dark:border-white/10">
                            {filteredSrsSets.map((set) => (
                              <div
                                key={set.id}
                                className="flex items-center justify-between gap-4 bg-white/70 dark:bg-white/[0.02] px-4 py-3 hover:bg-gray-50 dark:hover:bg-white/[0.04] transition-colors"
                              >
                    ...
                    {srsSets.length === 0 && !srsSearchQuery && (
                      <div className="rounded-xl border border-dashed border-black/10 dark:border-white/10 p-8 text-center text-sm text-black/70 dark:text-white/70">
                        ...
                        <p className="text-xs mb-4">
                          Enable SRS on your notecard sets to use spaced
                          repetition for better memorization.
                        </p>
                        <button className="inline-flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium bg-[#e30a5f] text-white hover:opacity-95">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="mt-1">
                  ...
                  {isLoadingSets && (
                    ...
                    >
                      {Array.from({ length: view === 'grid' ? 8 : 4 }).map(
                        (_, i) => (
                          <div
                            key={i}
