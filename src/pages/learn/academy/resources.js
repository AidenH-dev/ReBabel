...
export default function Resources() {
  ...
  return (
    <AuthenticatedLayout
      ...
      mainClassName="max-h-screen overflow-hidden"
    >
              ...
              <div className="mt-4 grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div className="rounded-xl border border-black/5 dark:border-white/10 bg-white dark:bg-surface-elevated p-5">
                  ...
                  <p className="text-sm text-black/60 dark:text-white/60 leading-relaxed">
                    Skim headlines and choose an interesting topic. NHK Easy is
                    perfect for intermediate learners to engage realistically
                    with the language. Fill in any blanks with Jisho and see if
                    you can successfully translate the article while reading.
                  </p>
                </div>
