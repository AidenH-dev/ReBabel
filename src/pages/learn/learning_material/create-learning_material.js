...
export default function CreateLearning_material() {
  ...
  const handleCreateLearning_material = async () => {
    ...
    try {
      ...
      clientLog.error('create_lm.create_failed', {
  ...
  return (
    <AuthenticatedLayout
      sidebar="main"
      title="Create Learning Material • ReBabel"
      ...
      <div className="mb-6">
        ...
        <div className="bg-white dark:bg-surface-card rounded-xl shadow-sm p-6">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Add your learning materials and organize sections with grammar and
            vocabulary
          </p>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900 dark:text-white">
                    {learning_materialInfo.institution}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-gray-600 dark:text-gray-400">
