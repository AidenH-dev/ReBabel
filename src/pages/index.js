        ...
        <div className="flex flex-col items-center justify-center w-full">
          ...
          <main className="flex flex-col items-center justify-center mt-24">
            <p className="text-center text-2xl leading-loose mb-8">
              A catalouge of resources for every type of learner!
              <div class="ml-2 relative inline-block">
                <div class="absolute inset-x-0 bottom-0 bg-[#B0104F] rounded-lg translate-y-1 h-[90%] transition-transform duration-2 "></div>
                <button class="relative px-4 py-2 text-lg text-white bg-[#E30B5C] active:bg-[#f41567] font-semibold rounded-lg transform transition-transform duration-2 active:translate-y-1">
                  Get Started
                </button>
              </div>
            </p>
                  ...
                  <div className="mx-auto container">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between py-5">
                      ...
                      >
                        ...
                        <h2 className="text-2xl sm:text-2.5xl md:text-3xl font-sans font-bold">
