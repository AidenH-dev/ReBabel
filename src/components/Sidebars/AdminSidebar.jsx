...
function AdminSidebar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex w-64 flex-col bg-surface-card border-r border-gray-200 dark:border-gray-800">
        <NavigationContent />
      </aside>
      ...
      <div className="md:hidden fixed top-4 left-4 z-50">
        <button
          ...
          className="p-2 rounded-lg bg-surface-card border border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
      ...
      {isMobileMenuOpen && (
        <>
          ...
          />
          <aside className="fixed top-0 left-0 w-64 h-screen bg-surface-card border-r border-gray-200 dark:border-gray-800 md:hidden z-40 overflow-y-auto">
            <NavigationContent />
          </aside>
        </>
      )}
