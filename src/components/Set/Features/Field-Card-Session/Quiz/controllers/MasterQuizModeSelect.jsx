...
export default function MasterQuizModeSelect({
  setTitle,
  setType,
  onSelectMode,
  onExit,
  ...
  const vocabModes = [
    ...
    },
    {
      ...
      borderColor: 'border-brand-pink/20 hover:border-brand-pink',
          ...
          {modes.map((mode) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div
                  className={`flex-shrink-0 w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-br ${mode.color} rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform`}
                >
