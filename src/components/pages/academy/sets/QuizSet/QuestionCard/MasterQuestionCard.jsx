    ...
    <div className="flex-1 flex flex-col items-center justify-center px-2 sm:px-0">
      <div className="w-full max-w-3xl">
        ...
        <div className="bg-white dark:bg-white/10 rounded-2xl shadow-xl p-4 sm:p-8 mb-4 sm:mb-6">
          ...
          <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-6 sm:mb-8 text-gray-900 dark:text-white break-words:w-flex flex-1 ...">
            {currentItem.question}
          </div>

          <div className="mb-6 sm:mb-6 text-xs sm:text-sm text-gray-500 dark:text-white/50">
    ...
    <div className="flex-1 flex flex-col items-center justify-center px-2 sm:px-0">
      <div className="w-full max-w-3xl">
        ...
        <div className="bg-white dark:bg-white/10 rounded-2xl shadow-xl p-4 sm:p-8 mb-4 sm:mb-6">
          ...
          <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-4 sm:mb-4 text-gray-900 dark:text-white break-words:w-flex flex-1 ...">
            {currentItem.question}
          </div>

          <div class="flex ...">  
            <div class="size-1 grow ..."></div>
            <div className="mb-2 text-xs sm:text-sm text-gray-500 dark:text-white/50 text-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-[#21333d] dark:to-[#1c2b35] rounded-lg h-fit px-1.5 py-1.5">
              <p>&#8682; Katakana</p>
            </div>
            <div class="size-1 grow ..."></div>
          </div>
