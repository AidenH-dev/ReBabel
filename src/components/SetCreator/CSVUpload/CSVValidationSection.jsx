...
export default function CSVValidationSection({
  ...
  return (
    <div className="space-y-4">
      <div className="bg-surface-deep rounded-lg p-3 border border-border-default">
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <FiArrowRight className="w-5 h-5 text-brand-pink" />
            </button>
          </div>
        </div>
      </div>
                  ...
                  {row.map((cell, cellIdx) => (
                    ...
                    >
                      <input
                        ...
                        className="w-full bg-transparent border-none outline-none text-gray-900 dark:text-white focus:bg-gray-50 dark:focus:bg-surface-deep px-2 py-1 rounded transition-colors overflow-hidden text-ellipsis"
                        placeholder="-"
                      />
                    </td>
                  ))}
