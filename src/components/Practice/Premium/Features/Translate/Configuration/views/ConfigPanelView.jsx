  ...
  return (
    <div className="sticky top-0 z-10"> {/** bg-white dark:bg-[#1c2b35] border border-black/5 dark:border-white/5 rounded-xl p-4 mb-4 shadow-sm */}
      ...
      <div className="flex items-center justify-center gap-2 mt-3 px-3 py-2 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/30">
        <span className="text-xs font-semibold text-amber-600 dark:text-amber-400 uppercase tracking-wide">Beta</span>
        <p className="text-xs text-amber-700 dark:text-amber-300/80">
          This feature may produce inconsistent results. We&apos;re working very hard to improve the experience. Your feedback is greatly appreciated!
        </p>
      </div>
    </div>
  );
