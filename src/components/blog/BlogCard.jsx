        ...
        <div className="p-6 flex flex-col flex-grow">
          <div className="flex flex-wrap gap-2 mb-3">
            {tags?.map((tag) => (
              <span
                key={tag}
                className="px-3 py-1 bg-brand-pink bg-opacity-20 text-white text-sm rounded-full font-fredoka"
              >
                {tag}
              </span>
            ))}
          ...
          <h2 className="text-2xl font-bold dark:text-white text-gray-900 mb-2 group-hover:text-brand-pink transition-colors font-fredoka">
            {title}
          </h2>

          <p className="dark:text-gray-400 text-gray-600 mb-4 line-clamp-2 flex-grow">
            {excerpt}
          </p>
